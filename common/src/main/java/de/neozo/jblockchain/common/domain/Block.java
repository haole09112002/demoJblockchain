...
public class Block {
    ...
    public Block(String previousBlockHash, List<Transaction> transactions, long tries) {
        this.previousBlockHash = previousBlockHash;
        this.transactions = transactions;
        this.tries = tries;
        this.timestamp = System.currentTimeMillis();
        this.merkleRoot = new String( calculateMerkleRoot());
    ...
    public byte[] calculateHash() {
        byte[] hashableData = ArrayUtils.addAll(previousBlockHash.getBytes(), merkleRoot.getBytes());
    ...
    public byte[] calculateMerkleRoot() {
        Queue<byte[]> hashQueue = new LinkedList<>(transactions.stream().map(Transaction::getBytesHash).collect(Collectors.toList()));
    ...
    public int getLeadingZerosCount() {
        ...
        return getHash().getBytes().length;
    }
    ...
    public boolean equals(Object o) {
        ...
        return this.hash.equals(block.getHash());
    }

...
public class Block {
    ...
    public Block(int previousBlockIndex,byte[] previousBlockHash, List<Transaction> transactions, long tries) {
    	this.index = previousBlockIndex != -1 ? previousBlockIndex +1 : 0;
